...
export const reportingWorkspaceMock: ReportingWorkspaceOverview = {
  ...
  runs: [
    {
      ...
      statusLabel: 'Pågår',
      statusTone: 'warning',
      nextAction: 'Fylle inn manglende næringsgrupper før innsending.',
    },
    {
      id: 'run-2',
      ...
      statusTone: 'ok',
      nextAction: 'Gjennomfør siste kontroll og godkjenn eksporten.',
    },
    {
      id: 'run-3',
  ...
  validationChecks: [
    ...
    {
      id: 'check-2',
      label: 'Næringsgrupper til Finanstilsynet',
      status: 'critical',
