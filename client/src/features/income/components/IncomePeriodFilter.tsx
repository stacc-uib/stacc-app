...
const IncomePeriodFilter = ({ range, minDate, maxDate, activePreset, onRangeChange, onPresetSelect, onReset }: Props) => {
    ...
    return (
        ...
        <div style={{ position: 'absolute', left: `${fromPct}%`, width: `${toPct - fromPct}%`, height: '4px', background: 'rgb(255, 116, 21)', borderRadius: '2px' }} />
        <div style={{ position: 'absolute', left: `${fromPct}%`, transform: 'translateX(-50%)', width: '16px', height: '16px', borderRadius: '50%', background: '#fff', border: '2px solid rgb(255, 116, 21)', boxShadow: '0 1px 3px rgba(0,0,0,0.15)' }} />
        <div style={{ position: 'absolute', left: `${toPct}%`, transform: 'translateX(-50%)', width: '16px', height: '16px', borderRadius: '50%', background: '#fff', border: '2px solid rgb(255, 116, 21)', boxShadow: '0 1px 3px rgba(0,0,0,0.15)' }} />
        </div>
        </div>
